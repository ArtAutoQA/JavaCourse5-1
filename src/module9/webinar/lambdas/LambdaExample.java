...
public class LambdaExample {
    public static void main(String[] args) {
        ...
        useConverter(new Converter<String, Integer, Long>() {
            @Override
        ...
        useConverter((from, anotherFrom) -> {
            if (anotherFrom == 10) return 10;
            return Integer.valueOf(from);
        });


        Converter<String, Integer, Long> converter = new Converter<String, Integer, Long>() {
            @Override
            public Integer convert(String from, Long anotherLong) {
                if (anotherLong == 10) return 10;
                return Integer.valueOf(from);
    ...
    static void useConverter(Converter<String, Integer, Long> converter) {
